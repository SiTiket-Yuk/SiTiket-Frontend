...
const Login = () => {
    ...
    const cekPassword = () => {
        if (password === '12345678') {   // UBAH DISINI UNTK CEK KE DATABASE
            return true;
        } else {
            return false;
        }
    ...
    const cekEmail = () => {
        if (email === 'tes@gmail.com'){  // UBAH DISINI UNTK CEK KE DATABASE
            return true;
        } else {
            return false;
        }
    ...
    return (
       <div className="container mx-auto flex flex-col">
			...
			<div className="flex md:flex-row md:gap-12 gap-1 flex-col items-center" style={{ position: 'fixed', top: '209px', width: '660px', height: '475px' }}>
                <Image
            ...
            >
			<div className="flex md:flex-row md:gap-12 gap-1 flex-col items-center">
                <div class="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none" style={{ width: '650px', height: '87px', marginTop:'10px' }}>
                    ...
                    <div class="mb-4 flex flex-col gap-7">
						<div class="relative h-[57px] w-[563px] min-w-[200px] " style={{ marginBottom: emailError && emailError == 'Masukkan format email yang sesuai' ? '20px' : '0px' }}>
                            ...
                            {emailError && emailError == 'Masukkan format email yang sesuai' && <p style={{ position: 'absolute', top: '120%', left: 3, color: '#AC0000' }}>{emailError}</p>}
                        </div>

                        <div class="relative h-[57px] w-[563px] min-w-[200px]" style={{ marginBottom: passwordError && passwordError == 'Password harus terdiri dari minimal 8 karakter' ? '20px' : '0px' }}>
                            <input
                                type="password"
                                class="peer h-full w-full rounded-full border border-[#d4a4be] bg-transparent px-6 py-3 font-sans text-base font-normal text-[#414141] outline outline-0 transition-all placeholder-shown:border-2 placeholder-shown:border-[#e7e7e7] focus:border-2 focus:border-[#d4a4be] disabled:border-0 disabled:bg-blue-gray-50"
                                placeHolder=" "
                    ...
                    <button
						...
						type="button" disabled={emailError == 'Masukkan email' || passwordError == 'Masukkan password' || emailError == 'Masukkan format email yang sesuai' || passwordError == 'Password minimal 8 karakter'}
						style={{ borderRadius: '40px', backgroundColor: emailError == 'Masukkan email' || passwordError == 'Masukkan password' || emailError == 'Masukkan format email yang sesuai' || passwordError == 'Password minimal 8 karakter' ? '#D4D4D4' : '#b5618d',
                        color: emailError == 'Masukkan email' || passwordError == 'Masukkan password' || emailError == 'Masukkan format email yang sesuai' || passwordError == 'Password minimal 8 karakter' ? '#A5A5A5' : '#FFFFFF', fontSize: '18px' }}
                    ...
                    {showPopupSuccess && (
                        <Popover backdrop="opaque" style={{ top: '50px', right:'394px', width: '463px', height: '260px', borderRadius: '20px'}}>
                        ...
                        Selamat Datang Kembali ...! {/*UBAH DISINI UNTUK AMBIL NAMA DRI DATABASE*/}
                        </div>
                    ...
                    {showPopupEmailSalah && (
                    <Popover backdrop="opaque" style={{ top: '69.5px', right:'421.5px',width: '406px', height: '240px', borderRadius: '20px'}}>
                        <PopoverContent className="w-[406px] h-[240px]">
                        <div style={{ width: '300px', height: '20px', textAlign: 'center', marginTop:'10px', color: 'black', fontWeight: 'bold', fontSize: '20px' }}>
                        Kesalahan Saat Login
                        </div>
                        <div style={{ width: '326px', height: '5px', textAlign: 'center', marginTop:'21px', color: 'black', lineHeight: '18px', fontSize: '16.5px'}}>
                        ...
                        <div style={{ justifyContent: 'center', marginTop: '55px'}}>
                            ...
                            type="button"
                            style={{ borderRadius: '40px', backgroundColor: '#b5618d', fontSize: '12px' }}
                            data-ripple-light="true"
                            onClick={togglePopup}
                            >
                                Kembali
                    ...
                    <p className="mt-4 ml-44 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased ">
                        Belum punya akun?
                        <Link href="/register-page" className="ml-1 font-semibold text-gray-700 transition-colors hover:text-blue">
                        <span>Daftar</span>
                        </Link>
                    </p>
                    </form>
