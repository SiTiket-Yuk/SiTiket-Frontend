...
const EditEvent = () => {
  ...
  const [date, setDate] = React.useState(
    parseAbsoluteToLocal("2021-04-07T18:45Z")
                      ...
                      <div>
                        ...
                        <div className="flex flex-row mt-4">
                          <Image
                            ...
                            alt="Last Edit Logo"
                          />
                          Terakhir Diedit : 01/31/2024{" "}
                          {/*harusnya cek ke database*/}
                        </div>
                        ...
                        <Modal2Buttons
                          message={
                            "Apakah Anda yakin ingin menghapus draft event ini?"
                          }
                          isOpen={isOpenModalDeleteDraft}
                          leftButton={"Ya"}
                          rightButton={"Kembali"}
                        ...
                        <div className="flex flex-row gap-4 pl-2 justify-center">
                          ...
                          <Modal2Buttons
                            message={
                              "Apakah Anda yakin ingin menjadikan event ini sebagai draft?"
                            }
                            isOpen={isOpenModalToDraft}
                            leftButton={"Ya"}
                            rightButton={"Kembali"}
